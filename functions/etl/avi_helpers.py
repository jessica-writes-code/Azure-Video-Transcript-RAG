# Modified from https://github.com/Azure-Samples/azure-video-indexer-samples
...
class Consts:
    ...
    ResourceGroup: str
    SubscriptionId: str
    ApiVersion: str = "2024-01-01"
    ApiEndpoint: str = "https://api.videoindexer.ai"
    AzureResourceManager: str = "https://management.azure.com"
...
class VideoIndexerClient:
    ...
    def list_videos_async(self) -> dict:
        """
        TODO
        """
        self.get_account_async()  # if account is not initialized, get it
    ...
    def get_prompt_content_async(
        self, video_id: str, raise_on_not_found: bool = True
    ) -> Optional[dict]:
        """
        Calls the promptContent API
    ...
    def get_prompt_content(
        self, video_id: str, timeout_sec: Optional[int] = None, check_alreay_exists=True
    ) -> Optional[dict]:
        """
